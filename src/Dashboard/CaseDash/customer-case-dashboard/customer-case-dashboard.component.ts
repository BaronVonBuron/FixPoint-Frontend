...
import {ProggressBarComponent} from '../../../progress-bar/progress-bar.component';
...
@Component({
  ...
  imports: [CaseInfoComponent, ProggressBarComponent, HeaderComponent, ContactComponent, CaseNotesComponent],
